...
const CameraCapture: React.FC<CameraCaptureProps> = ({ onPhotoTaken, onClose, isOpen }) => {
        ...
        {capturedPhoto ? (
          ...
          <div className="flex items-center justify-center space-x-6">
            ...
            <button
              ...
              className="w-20 h-20 bg-white rounded-full border-4 border-gray-300 hover:border-blue-500 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
            >
